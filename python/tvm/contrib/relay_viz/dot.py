...
class DotGraph(VizGraph):
    ...
    def __init__(
        ...
        # by the name starting "cluster" (all lowercase)
...
class DotPlotter(Plotter):
    ...
    The plotter accepts various graphviz attributes for graph, node, and edges.
    Please refer to https://graphviz.org/doc/info/attrs.html for available atrributes.
